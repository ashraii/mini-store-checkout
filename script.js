    ...
    function () {
        ...
        for (let i = 0; i < productCount; i++) {
            ...
            if (!Number.isFinite(price) || price <= 0) {
                ...
                validationMessage.textContent =`Price for Product ${i + 1} must be a positive number.`;
                hasError = true;
                break;
            }
            if (
                ...
                validationMessage.textContent =`Quantity for Product ${i + 1} must be a positive whole number.`;
                hasError = true;
                break;
            }
            const itemAmount =
